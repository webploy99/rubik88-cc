        ...
        <div class="max-w-6xl m-auto  md:px-2 md:py-1.5">
                <div class="flex flex-col md:flex-row justify-center md:justify-between items-center text-white relative">
                    ...
                    <div class="h-full opacity-100 md:relative absolute top-0 flex flex-col bg-gray-50 md:bg-transparent">
                        ...
                        <!-- menu item -->
                        <div class="max-w-6xl text-gray-500 pl-5 md:text-white text-sm font-[600] md:m-auto cursor-pointer">
                            <ul class="flex-col flex md:flex-row gap-5 md:border-none tracking-wider">
                                <li><a href=""><ion-icon class="text-[20px] hidden md:block " name="search-outline"></ion-icon></a></li>
                                <li><a href="./index.html"></a>TRANG CHỦ</li>
                                <li><a href="./instruct/Dangky/Dangky.html">ĐĂNG KÝ </a></li>
                                <li><a href="/instruct/Ruttien/Ruttien.html">RÚT TIỀN</a></li>
                                <li><a href="/instruct/khuyenmai/khuyenmai.html">KHUYẾN MÃI</a></li>
                            </ul>
                        </div>
